  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 space-y-8">
      ...
      >
        ...
        >
          <TabsList>
            <TabsTrigger value="today" data-ocid="shopper.analytics.today.tab">
              Today
            </TabsTrigger>
            <TabsTrigger value="week" data-ocid="shopper.analytics.week.tab">
              This Week
            </TabsTrigger>
            <TabsTrigger value="month" data-ocid="shopper.analytics.month.tab">
              This Month
            </TabsTrigger>
            <TabsTrigger
              value="custom"
        ...
        <CardContent className="p-0 overflow-x-auto">
          {myOrders.length === 0 ? (
            ...
            <Table>
              ...
              <TableBody>
                {myOrders.map((o, i) => (
                  <TableRow key={o.id} data-ocid={`shopper.order.row.${i + 1}`}>
